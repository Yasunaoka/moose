 ...
 */
class ComputeLinearElasticPFFractureStressAndNoDegradationEnergy : public ComputePFFractureStressBase,
                                             public GuaranteeConsumer
{
public:
  static InputParameters validParams();

  ComputeLinearElasticPFFractureStressAndNoDegradationEnergy(const InputParameters & parameters);
